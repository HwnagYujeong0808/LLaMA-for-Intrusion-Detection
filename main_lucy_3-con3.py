...
def load_checkpoint(model, optimizer, checkpoint_path):
    if os.path.exists(checkpoint_path):
        ...
        print_log(f"Checkpoint not found at {checkpoint_path}. Starting from scratch.")
...
def fit(args):
    ...
    optimizer = torch.optim.AdamW(llm_graph_transformer.parameters(), lr=1e-5)
      # Load checkpoint
    checkpoint_path = "model/20241120-073352_llm.pth"
    load_checkpoint(llm_graph_transformer, optimizer, checkpoint_path)
